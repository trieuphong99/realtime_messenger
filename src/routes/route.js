...
let initRoutes = (app) => {
  ...
  router.delete(
    "/contact/remove-contact-request",
    auth.checkLoggedin,
    contact.removeRequest
  );
  router.delete(
    "/contact/remove-received-contact-request",
    auth.checkLoggedin,
    contact.removeReceivedRequest
  );
  router.delete(
  ...
  router.put(
    "/contact/approve-received-contact-request",
    auth.checkLoggedin,
    contact.approveReceivedRequest
  );
  router.get(
  ...
  router.get(
    "/contact/read-more-sent-contacts",
    auth.checkLoggedin,
    contact.readMoreSentContacts
  );
  router.get(
    "/contact/read-more-received-contacts",
    auth.checkLoggedin,
    contact.readMoreReceivedContacts
  );
